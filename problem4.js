const storeData = {
  ...
  function findProductDetails(storeData){
    const {electronicsSection: {laptop:{available: laptopAvailable,price:laptopPrice }}},
    {clothingSection:{ shirt: {available: shirtAvailable, price: shirtPrice } } },  = storeData;
    return {
          laptopAvailable, 
          shirtAvailable, 
          laptopPrice, 
  ...
  const details = findProductDetails(storeData);
  console.log (details)
